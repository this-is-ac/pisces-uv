...
if __name__ == '__main__':
    ...
    for file in tqdm(dirs, desc = 'dirs'):
        # print(file)
        # if file == '2787.png' or file == '160_img_.png': continue
...
# python preprocess.py --image-path /home/aditya/llve/StableLLVE/uw_video_2/images/ --depthmap-path /home/aditya/llve/StableLLVE/uw_video_2/depthmaps/ --output-path /home/aditya/llve/StableLLVE/uw_video_2/train/