# The flow warp operations from https://github.com/XiaohangZhan/conditional-motion-propagation
...
class WarpingLayerBWFlow(nn.Module):
    ...
    def forward(self, image, flow):
        ...
        return torch.nn.functional.grid_sample(image, grid, padding_mode='reflection')
