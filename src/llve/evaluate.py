...
if __name__ == '__main__':
    ...
    for file in tqdm(dirs):
        ...
        if f[-3:].lower() == "png":
            ...
            # print("{}: psnr={:.6f}, psnr_L={:.6f}, ssim={:.6f}, uiqm={:.6f}, uciqe={:.6f}".format(file[4:-4].ljust(len(max(dirs, key=len))-8),psnr,psnr_l,ssim,uiqm,uciqe))
...
# python evaluate.py --output-path /home/aditya/llve/StableLLVE/outputs/PHiSHVideo_01_K10_UIEB --reference-path /home/aditya/llve/StableLLVE/data/gt