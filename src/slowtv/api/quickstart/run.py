...
def colorize_disp(disp: np.ndarray) -> np.ndarray:
    ...
    disp = plt.get_cmap('gray')(disp)[..., :-1]  # Remove alpha
    return disp
...
if __name__ == '__main__':
    ...
    parser.add_argument('--width', default=512, help='Width required when resizing landscape images.') #640
    parser.add_argument('--height', default=512, help='Height required when resizing portrait images.') #384
    parser.add_argument('--device', default=None, help='Device to run predictions on.')

    main(parser.parse_args())

# python run.py --ckpt-file /home/aditya/slowtv_monodepth/api/quickstart/kbr.ckpt --img-dir /home/aditya/llve/StableLLVE/data/uw_video/images --out-dir /home/aditya/llve/StableLLVE/data/uw_video/depthmaps
# python run.py --ckpt-file /home/aditya/slowtv_monodepth/api/quickstart/kbr.ckpt --img-dir /home/aditya/llve/StableLLVE/uw_video_2/images --out-dir /home/aditya/llve/StableLLVE/uw_video_2/depthmaps
